...
class TPreviousDisasterTile extends StatelessWidget {
  const TPreviousDisasterTile({
    super.key,
  });
    ...
    return TAppBar(
      title: Column(
        ...
        children: [
          ...
          Text("Previous Disasters", style: Theme.of(context).textTheme.headlineSmall!.apply(color: TColors.white)),
        ],
      ),
