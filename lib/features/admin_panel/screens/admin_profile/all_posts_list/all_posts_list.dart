...
import '../../../controller/all_disaster_post_controller/all_disaster_post_controller.dart';

class AllPostsListScreen extends StatelessWidget {
  const AllPostsListScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(AllDisasterFetchController());
