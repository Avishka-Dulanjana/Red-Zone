...
class TAnimationLoaderWidget extends StatelessWidget {
  ...
  //
  // Parameters:
  // - [text] (optional): The text to displayed below the animation.
  // - [animation] (optional): The path to thr Lottie animation file.
  // - [showAction] (optional): Whether to show an action button below the text.
  // - [actionText] (optional): The text to be displayed on the action button.
  // - [onActionPressed] (optional): The callback to be called when the action button is pressed.
